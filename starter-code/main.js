...
var cardsInPlay = [];
//A function generates n pairs of cards randomly
//heart spade club diamond 1-13
var heads = ["Clubs","Diamonds","Hearts","Spades"];
function shuffleCards(pair){
  var shuffled =[];
	for(var i = 0;i<pair;i++){
	  shuffled[i]=heads[Math.floor((Math.random() * 3))]+" "+Math.floor((Math.random() * 13) + 1)+".png";
	}
	return shuffled;
}
